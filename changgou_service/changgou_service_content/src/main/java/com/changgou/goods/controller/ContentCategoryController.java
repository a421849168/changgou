...
public class ContentCategoryController {
    ...
    public Result<PageInfo> findPage(@RequestBody(required = false)  ContentCategory contentCategory, @PathVariable(value = "{page}")  int page, @PathVariable(value = "{size}")  int size){
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody  ContentCategory contentCategory,@PathVariable(value = "{id}") Long id){
        //设置主键值
     ...
     */
    @GetMapping("/{id}")
    public Result<ContentCategory> findById(@PathVariable(value = "{id}") Long id){
